...
const Header = () => {
  ...
  return (
    <>
      {/* Winter Sale Marquee Banner */}
      <div className="fixed top-0 left-0 right-0 z-[60] bg-gradient-to-r from-rose-600 via-pink-600 to-rose-600 py-2 overflow-hidden">
        <div className="animate-marquee whitespace-nowrap flex">
          {[...Array(6)].map((_, i) => (
            <span key={i} className="mx-8 text-white font-bold text-sm tracking-wider inline-flex items-center gap-2">
              ❄️ WINTER SALE IS LIVE — 20% OFF
      ...
      <header className={`fixed top-8 left-0 right-0 z-50 transition-all duration-300 backdrop-blur-xl bg-[rgba(30,30,36,0.85)] shadow-xl border-b-0 before:content-[''] before:absolute before:inset-x-0 before:bottom-0 before:h-1 before:bg-gradient-to-r before:from-brand-purple before:via-[#e7dbc7] before:to-brand-purple before:rounded-b-xl before:blur-[2px] ${isScrolled
